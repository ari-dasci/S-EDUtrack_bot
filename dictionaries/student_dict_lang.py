...
""" welcome_text = {
  "ES": f'Bienvenido al asistente  EDUtrack <b>{EDUtrack.my_bot.username}</b>, te acompañare durante el curso para que puedas opinar/evaluar sobre algunos elementos claves en tu aprendizaje.\n\nEscribe el símbolo<b> " / " </b>y te mostrare los comandos que puedes utilizar para que trabajemos juntos. Aquí tienes una breve explicación de cada uno.\n\n\
  ...
  "EN": f'Welcome to the EDUtrack assistant {EDUtrack.my_bot.username}. I will accompany you during the course so that you can give your opinion/evaluate some key elements in your learning.\n Write the symbol <b> "/" </b> and I will show you the commands you can use to work together. Here'+"'s a brief explanation of each one.\n\n\
